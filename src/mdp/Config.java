...
public class Config {
	...
	public static final int MAZE_LENGTH = 150, MAZE_WIDTH = 200, GRID_LEN = 10;
	...
	public static final int[] FRAME_SIZE ={850,1050};

	//Robot
	public static final int robotWaitingTime = 100;
	public static final double startPointX = 210.0;
	public static final double startPointY = 30.0;
	public static final double endPointX = 30.0;
	public static final double endPointY = 160.0;
